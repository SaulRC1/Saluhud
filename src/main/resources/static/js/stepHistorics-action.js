document.addEventListener("DOMContentLoaded", function () {
    ...
    const userId = document.getElementById('dailyStepsData').getAttribute('data-user-id');
    ...
    updateButton.addEventListener('click', function () {
        if (selectedId) {
            ...
            document.getElementById('confirmButton').addEventListener('click', function () {
                 window.location.href = '/users/dailyStepsHistorics/' + userId + '/entries/edit/' + selectedId;
            });
    ...
    deleteButton.addEventListener('click', function () {
        if (selectedId) {
            ...
            document.getElementById('confirmButton').addEventListener('click', function () {
                window.location.href = '/users/dailyStepsHistorics/' + userId + '/entries/delete/' + selectedId;
            });
