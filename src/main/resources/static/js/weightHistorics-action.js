document.addEventListener("DOMContentLoaded", function () {
    ...
    const userId = document.getElementById('weightData').getAttribute('data-user-id');
    ...
    updateButton.addEventListener('click', function () {
        if (selectedId) {
            ...
            document.getElementById('confirmButton').addEventListener('click', function () {
                 window.location.href = '/users/weightHistorics/' + userId + '/entries/edit/' + selectedId;
            });
    ...
    deleteButton.addEventListener('click', function () {
        if (selectedId) {
            ...
            document.getElementById('confirmButton').addEventListener('click', function () {
                window.location.href = '/users/weightHistorics/' + userId + '/entries/delete/' + selectedId;
            });
